...
export class SearchBox extends Component {
    ...
    handleSubmit = (e) => {
        ...
        //console.log("handleSubmit", config, state);
        if (errors.length > 0) {
                        ...
                        if (draw.length > 0) {
                            ...
                            draw = draw.map((item, index) => {
                                ...
                                if (item?.balloon) {
                                  ...
                                  let plusT = item?.plusTolerance ? item.plusTolerance.replaceAll("+", "") : "";
                                  let minusT = item?.minusTolerance ? item.minusTolerance.replaceAll("-", "") : "";    
                ...
                >
                    ...
                    <div className="">
                        <Nav className="align-items-center " >
                            <NavItem style={{ margin:"2px  10px 0  10px",width:"150px"} }>
                                <div>
                                    <FormGroup >
                                        <Label for="DrawingNo">
                                            Drawing No
                            ...
                            <NavItem className="box" style={{ margin: "12px  10px 0  0"  }}>
                                <Button color="light" className={classNames("light-btn buttons searchDrawing primary", { "primary_hover": !state.isDisabledSearchBtn })} 
                                ...
                                >
                                    ...
                                    {state.isDisabledSearchBtn && (<> &nbsp;&nbsp;<Image name='search.svg' className="icon" alt="Search" />&nbsp;&nbsp;</>)}
                            ...
                            <NavItem className="box" style={{ margin: "12px  10px 0  0" }}>
                                ...
                                disabled={drawingDetails.length > 0 ? false :true}
                                    ...
                                    {drawingDetails.length === 0 && (<Image name='paint_brush.svg' className="icon" alt="Clear" />)}
