...
export class Pagination extends Component {
    ...
    handleItemView = (e) => {
        ...
        //console.log(state.ItemView)
        let index = e.target.value;
        if (state.ItemView !== index) {
            useStore.setState({ zoomed: false, scrollPosition :0})
        }
            ...
            <>
                {state.ItemView !== null && (
                    <div className="container">
                        <Nav style={{ margin: "12px  10px 0  0" }}>
                            <NavItem style={{ margin: "2px  10px 0  0" }}>
                                ...
                                >
                                    ...
                                    {this.state.isDisabledPrev && (<Image name='arrow-line-left.svg' className="icon" alt="Prev" />)}
                                    ...
                                    >
                                        {drawingDetails.map((item, index) => {
                                            ...
                                            return (
                                                ...
                                                <option key={index} value={index} className="text-dark" style={{ cursor: "pointer" }} >{item.fileName}</option>
                                            );
                                        })
                                        }
                                    </select>
                            ...
                            <NavItem style={{ margin: "2px  10px 0  0" }}>
                                ...
                                >
                                    ...
                                    {this.state.isDisabledNext && (<Image name='arrow-line-right.svg' className="icon" alt="Next" />)}
