 ...
 public   class ImageIOHelper
    {
        ...
        public static IList<System.Drawing.Image> GetImageList(FileInfo imageFile)
        {
        ...
        public static void MergeTiff(string[] inputImages, string outputTiff)
        {
            ...
            try
            {
                ...
                foreach (string inputImage in inputImages)
                {
                    if (frame == 0)
                    {
                        pages = (Bitmap)System.Drawing.Image.FromFile(inputImage);
                    ...
                    else
                    {
                        ...
                        try
                        {
                            bm = (Bitmap)System.Drawing.Image.FromFile(inputImage);
                            pages.SaveAdd(bm, ep);
                        }
                        catch (System.Runtime.InteropServices.ExternalException e)
                        {
